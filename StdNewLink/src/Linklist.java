...
public class Linklist {
	...
	//--------------------------------------------------------
	public void insertFirst(String id,String name1,String unit1,String grade1) { // make new link
	...
	//---------------------------------------------------------------
	//public SubjectLink addAfter(String id,String name,String unit,String grade) {
	//	SubjectLink newSubjectLink = new SubjectLink(id,name,unit,grade);
	//	SubjectLink current = first;
		
		 
	//	while(first == null) {
		//	if(newSubjectLink != null)
		//			current.next = newSubjectLink;
	//		else {
		//		return null;
		//	}
	//	}
